...
const Q = [
  ...
  { id: 141, group: "verbatim", statement: "I don't want to get angry. I don't want to get pissed off. That's what I want to get from coaching. (Dane)", options: ["Motivational Direction — Away From", "Motivational Direction — Towards", "Stress Coping — Assertive", "Scenario Type — Pessimistic"], correct: 0, explanation: "The goal is framed entirely as what he wants to stop, not what he wants to move toward — pure Away From, stated twice." },
  { id: 142, group: "verbatim", statement: "I want to take more control of where my career wants to be in the next 10 to 15 years. (Dane)", options: ["Time Zones — Future", "Motivational Direction — Towards", "Modus Operandi — Necessity", "Quality of Life — Doing"], correct: 0, explanation: "Attention is projected years ahead onto a planned career trajectory — the Future time-zone. (Towards is present too, but the sort being tested is temporal.)" },
  { id: 143, group: "verbatim", statement: "When things don't come my way, a lot of it's to do with control — if things aren't going my way, I start to get pissed off. (Dane)", options: ["Values — High Value (control)", "Scenario Type — Pessimistic", "Responsibility Sort — Over", "Interactive — Competitive"], correct: 0, explanation: "Control is the charged criterion the whole reaction organises around — the core Values marker. He even names it explicitly." },
  { id: 144, group: "verbatim", statement: "I just want to notice before I do that, and be a little bit more aware of what I'm actually saying and how I'm presenting. (Dane)", options: ["Self Monitoring — High", "Attention — Self-Referent", "Social Presentation — Artfully Shrewd", "Stress Coping — Assertive"], correct: 0, explanation: "He turns attention inward onto his own state and delivery in real time — and wants to do it more. The high pole of self-monitoring." },
  { id: 145, group: "verbatim", statement: "I've got a bit of a detector — people talking clichés, that's not something I appreciate. I like directness. (Dane)", options: ["Directness — Direct/Low Context", "Communication Channel — Verbal", "Convincer Demo. — Never", "Social Convincer — Distrusting"], correct: 0, explanation: "He wants things said plainly and reacts against padding and implication — the Direct/Low Context pole." },
  { id: 146, group: "verbatim", statement: "I want to be able to speak with a bit more authority around what I'm doing — it comes a lot from how I present, how I speak, how I engage. (Dane)", options: ["Self Experience — Role/Position", "Authority — Internal Referencing", "Self Confidence — Low", "Dominance — Power"], correct: 0, explanation: "He locates himself through his professional presentation and standing — the Role/Position mode of self-experience. (Not low confidence: he's describing an identity investment, not doubting his skill.)" },
  { id: 147, group: "verbatim", statement: "There's a bit of negativity I find I use a little bit too much in my everyday things — I want to use it where it's appropriate and not where it isn't. (Dane)", options: ["Scenario Type — Pessimistic (contextualised, not fixed)", "Durability — Impermeable", "Stress Coping — Passive", "Self Confidence — Low"], correct: 0, explanation: "A default negative/problem scan he's aware of and wants to make contextual rather than automatic — the pessimistic scenario filter, held with insight." },
];
...
const RQ = [
  ...
  { id: 113, group: "verbatim", statement: "People talking clichés — I've got a bit of a detector for it. I like directness. (Dane)", options: ["Language — the exact words and their form are what he tracks and judges", "Kinaesthetic — 'detector' is a felt sense", "Auditory — he's listening to tone", "Visual"], correct: 0, explanation: "His unit of processing is the wording itself — clichéd phrasing versus direct phrasing. He lives in the language channel." },
  { id: 114, group: "verbatim", statement: "Sometimes in a meeting with my boss I get a bit angry and say things I probably shouldn't say. (Dane)", options: ["Language — his concern is the specific words that come out, not images or sensations", "Visual — how he appears in the meeting", "Kinaesthetic — the anger sensation", "Auditory — his tone of voice"], correct: 0, explanation: "The regret is about the said words — what left his mouth. The anger is the trigger, but the channel he's monitoring is language." },
];
...
const PQ = [
  ...
  { id: 114, group: "verbatim", statement: "Dane: \"I've got a bit of a detector — people talking clichés, I don't appreciate that. I like directness.\" Best pacing approach?", options: ["Be plain and specific — name things directly, skip the coaching jargon and reassurance padding", "Use warm, elaborate metaphors to build rapport", "Soften every observation with qualifiers so he feels safe", "Mirror his exact sentences back at length"], correct: 0, explanation: "He's told you his mismatch trigger outright. Pacing a low-context, directness-preferring client means dropping the cliché register, not laying it on." },
  { id: 115, group: "verbatim", statement: "Dane: \"I don't want to get angry, I don't want to get pissed off — that all shifts when we shift the stuff on the inside.\" How do you pace his motivation before leading?", options: ["\"So the work is making sure those reactions stop running you — let's build what puts you back in control of them.\"", "\"Let's focus on an exciting vision of the leader you want to become.\"", "\"Let's set some ambitious stretch goals for the year.\"", "\"Forget the anger — what do you want MORE of?\""], correct: 0, explanation: "He's Away From and control-valued. Pace the avoidance and the control criterion first; a premature Towards vision mismatches how his motivation actually moves." },
  { id: 116, group: "verbatim", statement: "Dane opens with past trauma, then hypervigilance, then over-used negativity, then his career security worry — layered, in one breath. What does pacing him well require?", options: ["Empathetic-level listening — hear the systemic thread (safety/control) linking the layers, not just the four separate topics", "Factual listening — note each topic and pick the most urgent to tackle", "Redirecting him to choose one issue before you continue", "Reassuring him each concern is manageable"], correct: 0, explanation: "The layers are one system organised around safety and control. Only listening AS him (level 3) surfaces the thread; factual listening would file four problems and miss it." },
];
...
const GQ = [
  ...
  { id: 23, group: "verbatim", statement: "Dane: \"When things don't come my way, I get pissed off.\" Which grounding question opens the map?", options: ["\"Which things specifically — and 'come your way' meaning what exactly?\"", "\"Why do you let it get to you?\"", "\"Doesn't everyone feel that way?\"", "\"What's your plan to stay calm?\""], correct: 0, explanation: "'Things' is an unspecified referent and 'come my way' an unspecified process — recover both before working the reaction." },
  { id: 24, group: "verbatim", statement: "Dane: \"A lot of it's to do with control.\" Which pattern is 'control' here, and how do you ground it?", options: ["Nominalisation — a frozen process; 'controlling what, specifically, and how would you know you had it?'", "Universal quantifier — challenge the all-ness", "Mind reading — recover the evidence", "Lost performative — says who?"], correct: 0, explanation: "'Control' is a verb turned into a thing. Can it fit in a wheelbarrow? No — put it back into process form to see what controlling would actually look like for him." },
  { id: 25, group: "verbatim", statement: "Dane: \"If things aren't going my way, I tend to get a bit pissed off and I've got to pull myself back.\" Which pattern, and the grounding move?", options: ["Cause-effect — 'how specifically does things not going your way cause the anger? What happens between the two?'", "Complex equivalence — this means that", "Simple deletion — about whom?", "Modal operator of necessity"], correct: 0, explanation: "An external event is claimed to drive an internal state directly. Grounding the link exposes the space between trigger and reaction — the exact space coaching works in." },
];
...
const XQ = [
  ...
  { id: 19, group: "verbatim", statement: "The coach reframes: \"If we only coach to the anger, we're not coaching to the cause.\" In Meta-States terms, what is Dane's anger sitting on top of?", options: ["A higher frame (safety/control) that governs the anger from above — the frame is the leverage, not the feeling", "Nothing — the anger is the primary problem to remove", "A rep-system preference", "A simple bad habit"], correct: 0, explanation: "The anger is a lower-level state driven by a governing frame about control and safety. Change the frame and the reaction it generates reorganises — coaching to the cause." },
  { id: 20, group: "verbatim", statement: "Dane: \"I want to be a better person — or at least not so much a better person...\" then talks image and identity. Which self-reflexive question goes to his inner game?", options: ["\"What would being that kind of person mean about who you are — and whose standard is 'better' measured against?\"", "\"What behaviours would a better person do differently?\"", "\"When did you decide you weren't good enough?\"", "\"How much better, on a scale of 1 to 10?\""], correct: 0, explanation: "Meaning + Identity, plus checking the referent of 'better' — his self-correction ('or at least not...') signals an unexamined frame worth surfacing rather than behaviourally itemising." },
];
